...
var require_error_to_string = __commonJS((exports, module) => {
  var DESCRIPTORS = require_descriptors();
  var fails = require_fails();
  var anObject = require_an_object();
...
var require_delete_property_or_throw = __commonJS((exports, module) => {
  var tryToString = require_try_to_string();
  var $TypeError = TypeError;
...
var require_array_iteration_from_last = __commonJS((exports, module) => {
  var bind = require_function_bind_context();
  var IndexedObject = require_indexed_object();
  var toObject = require_to_object();
  var lengthOfArrayLike = require_length_of_array_like();
...
var require_array_sort = __commonJS((exports, module) => {
  var arraySlice = require_array_slice_simple();
  var floor = Math.floor;
...
var require_engine_ff_version = __commonJS((exports, module) => {
  var userAgent = require_engine_user_agent();
...
var require_engine_is_ie_or_edge = __commonJS((exports, module) => {
  var UA = require_engine_user_agent();
  module.exports = /MSIE|Trident/.test(UA);
});

// node_modules/core-js/internals/engine-webkit-version.js
var require_engine_webkit_version = __commonJS((exports, module) => {
  var userAgent = require_engine_user_agent();
...
var require_array_to_reversed = __commonJS((exports, module) => {
  var lengthOfArrayLike = require_length_of_array_like();
...
var require_array_from_constructor_and_list = __commonJS((exports, module) => {
  var lengthOfArrayLike = require_length_of_array_like();
...
var require_array_with = __commonJS((exports, module) => {
  var lengthOfArrayLike = require_length_of_array_like();
  var toIntegerOrInfinity = require_to_integer_or_infinity();
...
var require_array_buffer_basic_detection = __commonJS((exports, module) => {
...
var require_es_array_buffer_slice = __commonJS(() => {
  ...
  var INCORRECT_SLICE = fails(function() {
    return !new ArrayBuffer2(2).slice(1, undefined).byteLength;
  });
...
var require_math_log10 = __commonJS((exports, module) => {
  var log = Math.log;
...
var require_is_integral_number = __commonJS((exports, module) => {
  var isObject = require_is_object();
  var floor = Math.floor;
...
var require_es_number_to_fixed = __commonJS(() => {
  ...
  $({ target: "Number", proto: true, forced: FORCED }, {
    toFixed: function toFixed(fractionDigits) {
      ...
      if (number !== number)
        return "NaN";
      if (number <= -1000000000000000000000 || number >= 1000000000000000000000)
...
var require_engine_is_ios_pebble = __commonJS((exports, module) => {
  var userAgent = require_engine_user_agent();
...
var require_engine_is_deno = __commonJS((exports, module) => {
  module.exports = typeof Deno == "object" && Deno && typeof Deno.version == "object";
});

// node_modules/core-js/internals/engine-is-browser.js
var require_engine_is_browser = __commonJS((exports, module) => {
...
var require_is_data_descriptor = __commonJS((exports, module) => {
  var hasOwn = require_has_own_property();
...
var require_es_reflect_get = __commonJS(() => {
  var get = function(target, propertyKey) {
...
var require_es_reflect_set = __commonJS(() => {
  var set = function(target, propertyKey, V) {
...
var require_string_trim_end = __commonJS((exports, module) => {
...
var require_string_trim_start = __commonJS((exports, module) => {
...
var require_typed_array_constructors_require_wrappers = __commonJS((exports, module) => {
  ...
  module.exports = !NATIVE_ARRAY_BUFFER_VIEWS || !fails(function() {
    ...
    return new Int8Array2(new ArrayBuffer2(2), 1, undefined).length !== 1;
  });
});
...
var require_to_uint8_clamped = __commonJS((exports, module) => {
  var round = Math.round;
  module.exports = function(it) {
    var value = round(it);
...
var require_is_big_int_array = __commonJS((exports, module) => {
  var classof = require_classof();
  module.exports = function(it) {
    var klass = classof(it);
...
var require_to_big_int = __commonJS((exports, module) => {
  var toPrimitive = require_to_primitive();
  var $TypeError = TypeError;
  module.exports = function(argument) {
...
var require_typed_array_species_constructor = __commonJS((exports, module) => {
  var ArrayBufferViewCore = require_array_buffer_view_core();
  var speciesConstructor = require_species_constructor();
  var aTypedArrayConstructor = ArrayBufferViewCore.aTypedArrayConstructor;
...
var require_typed_array_from_species_and_list = __commonJS((exports, module) => {
  var arrayFromConstructorAndList = require_array_from_constructor_and_list();
...
var require_base64_map = __commonJS((exports, module) => {
...
var require_try_node_require = __commonJS((exports, module) => {
  var IS_NODE = require_engine_is_node();
  module.exports = function(name) {
    try {
      if (IS_NODE)
...
var require_dom_exception_constants = __commonJS((exports, module) => {
  module.exports = {
...
var require_engine_is_bun = __commonJS((exports, module) => {
  module.exports = typeof Bun == "function" && Bun && typeof Bun.version == "string";
});

// node_modules/core-js/internals/schedulers-fix.js
var require_schedulers_fix = __commonJS((exports, module) => {
  var global2 = require_global();
  var apply = require_function_apply();
  var isCallable = require_is_callable();
...
var require_map_helpers = __commonJS((exports, module) => {
  var uncurryThis = require_function_uncurry_this();
...
var require_set_helpers = __commonJS((exports, module) => {
  var uncurryThis = require_function_uncurry_this();
...
var require_structured_clone_proper_transfer = __commonJS((exports, module) => {
  var global2 = require_global();
  var fails = require_fails();
  var V8 = require_engine_v8_version();
  var IS_BROWSER = require_engine_is_browser();
...
var require_url_constructor_detection = __commonJS((exports, module) => {
  var fails = require_fails();
  var wellKnownSymbol = require_well_known_symbol();
  var DESCRIPTORS = require_descriptors();
  var IS_PURE = require_is_pure();
...
var require_web_url_search_params_constructor = __commonJS((exports, module) => {
...
// public/js/index.js
var stable = __toESM(require_stable(), 1);
...
// public/js/mapbox.js
function mapbox_default(locations) {
...
var mapbox2 = document.getElementById("map");
if (mapbox2) {
  const locations = JSON.parse(mapbox2.dataset.locations);
  mapbox_default(locations);
}
